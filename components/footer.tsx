  ...
  return (
    <footer className="bg-[#111a22] text-white">
      <div className="mx-auto grid max-w-site gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[1.25fr_.7fr_1fr] lg:py-20">
        <div>
          <BrandMark inverted />
          <p className="mt-7 max-w-md text-sm leading-7 text-white/58">Integrated real estate and infrastructure development guided by strategic planning, efficient design, and disciplined execution.</p>
          <p className="mt-6 text-xs font-bold uppercase tracking-[0.24em] text-copper">Building Value. Developing Futures.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="mt-5 space-y-5 text-sm leading-6 text-white/65">
            ...
            <a href={`mailto:${contact.alternateEmail}`} className="ml-7 block transition hover:text-white">{contact.alternateEmail}</a>
          </div>
        </div>
      </div>
